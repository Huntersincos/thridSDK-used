...
+ (instancetype)modelWithDictionary:(NSDictionary *)dictionary {
    ...
    // Class对象是指向一个objc_class指针  struct objc_class : objc_object实现   objc_object是个isa指针  objc_class继承与objc_object Class的属性列表:const property_array_t properties() ,方法列表: const method_array_t methods()  协议列表:protocol_array_t protocols() ===class_rw_t  成员变量信息存储在class_ro_t内部
